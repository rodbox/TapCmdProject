...
<div class="input-group">
     <input id="dash_x" type="text" class="form-control xs"  value="<?php echo $_SESSION['val']['dash_x']?? "5" ?>">
     </div>
     <div class="input-group">
     <input id="dash_w" type="text" class="form-control xs"  value="<?php echo $_SESSION['val']['dash_w']?? "10" ?>">
</div>