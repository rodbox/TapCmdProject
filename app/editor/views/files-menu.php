<form id="files_search" data-cb="input_files" action="<?php $c->urlExec('editor','files_search'); ?>" class="form-live form-files">
    <div class="input-group">
        <input type="text" id="file_project" placeholder="" data-target="#files_search" name="file" class="form-control on-focusin on-focusout on-keyup" data-cb-keyup="fileSearch" data-cb-app="editor" data-cb-focusin="fileSearchOn" data-cb-focusout="fileSearchOff" >
