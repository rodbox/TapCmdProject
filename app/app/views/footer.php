<footer>
          <!-- BEGIN ROW  -->
      <div class="btn-group-vertical btn-group-sm btn-group-primary bg-2 c-5" style="margin:0.5rem;">
            ...
            <a href="<?php $c->urlPopup('app','tap') ?>" class="btn btn-popup" data-cb="false" title="term" data-popup="tap"><i class="fa fa-th"></i></a>
