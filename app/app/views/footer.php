...
<nav class="navbar navbar-dark bg-inverse navbar-fixed-bottom">
    <form action="#" id="form-footer" class="form-inline">
        <div class="container">
            <!-- BEGIN ROW  -->
            <div class="row ">
                <div class="col-md-12 col-xs-12">
                    <div class="input-group">
                     <div class="input-group-btn">
                            ...
                            <?php $c->btn_context('<i class="fa fa-columns"></i>','sidebar'); ?>
                            <?php $c->btn_context('<i class="fa fa-code"></i>','editor'); ?>
                            <?php $c->btn_context('<i class="fa fa-eye-slash"></i>','iframe'); ?>
                            <?php $c->btn_context('<i class="fa fa-flask"></i>','labs'); ?>
                            <?php $c->btn_context('<i class="fa fa-columns"></i>','quickbar'); ?>
